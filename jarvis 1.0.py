...
def Creator():
    speak("Pushkar is an extra-ordinary person ,"
    "He has a passion for Programming, Artificial Intelligence and Machine Learning and even designing"
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'time' in query:
            ...
            speak("Thanks to Pushkar. further it is a secret")
            ...
            try:
                jsonObj = urlopen('''https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=5155014e637a4ac7b4b5e718ecc09a5f''')
                data = json.load(jsonObj)
                i = 1
                speak('Here are top techcrunch news') 
                print('''=============== TOP HEADLINES ============'''+ '\n')
        ...
        elif 'tell me about pushkar' and 'creator' in query:
            Creator()
            ...
            client = wolframalpha.Client("8Q45QG-7KVUYLJG38")
